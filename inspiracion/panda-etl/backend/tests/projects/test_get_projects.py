...
@patch("app.repositories.project_repository.ProjectRepositoryImpl.get_projects")
...
def test_get_projects_invalid_page():
    ...
    response = client.get("/api/v1/projects?page=0&page_size=2")
...
def test_get_projects_invalid_page_size():
    ...
    response = client.get("/api/v1/projects?page=1&page_size=101")
