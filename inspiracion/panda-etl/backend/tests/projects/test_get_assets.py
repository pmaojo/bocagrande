...
def test_get_assets_success(mock_get_assets, mock_db):
    ...
    response = client.get("/api/v1/projects/1/assets?page=1&page_size=2")
...
def test_get_assets_invalid_page():
    ...
    response = client.get("/api/v1/projects/1/assets?page=0&page_size=2")
...
def test_get_assets_invalid_page_size():
    ...
    response = client.get("/api/v1/projects/1/assets?page=1&page_size=101")
