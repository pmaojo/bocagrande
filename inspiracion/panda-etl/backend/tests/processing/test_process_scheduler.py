...
class TestProcessScheduler(unittest.TestCase):
    def setUp(self):
        ...
        self.assertIsInstance(self.scheduler.waiting_processes, deque)
    ...
    def test_reprocess_holding_processes(self, _):
        ...
        process_id = 2
        self.scheduler.waiting_processes = deque([process_id])
    ...
    def test_stop_scheduler_when_empty(self, _):
        ...
        self.scheduler.waiting_processes = deque()  # Empty the queue
        self.scheduler._reprocess_holding_processes()
    ...
    def test_reprocess_multiple_processes(self, _):
        ...
        process_ids = [1, 2, 3]
        self.scheduler.waiting_processes = deque(process_ids)
        ...
        self.assertEqual(list(self.scheduler.waiting_processes), [])
    ...
    def test_scheduler_restart_after_adding_new_process(self, _):
        ...
        process_id_1 = 1
        process_id_2 = 2
        self.scheduler.waiting_processes = deque([process_id_1])
    ...
    def test_queue_remains_deque_after_operations(self, _):
        """Ensure waiting_processes stays a deque after queue operations."""
        self.scheduler.waiting_processes.append(1)
        self.scheduler._reprocess_holding_processes()
