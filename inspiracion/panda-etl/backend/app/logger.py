...
class Logger:
    ...
    def warning(self, message: str) -> None:
        """Log a warning message and store the log entry."""
        self._logger.warning(message)
        self._logs.append(
            {
                "msg": message,
...
def get_logger(save_logs: bool = True, verbose: bool = False) -> Logger:
    """
    Get a singleton instance of the Logger class.
    
    Args:
        save_logs: Whether to save logs to a file
        verbose: Whether to print logs to stdout
    ...
    if _logger_instance is None:
        _logger_instance = Logger(save_logs=save_logs, verbose=verbose)
